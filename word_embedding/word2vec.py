...
import sourceCodeReader as srcReader
...
def saveModel(embeddings):
  model = {reverse_dictionary[i]: embeddings[i,:] for i in xrange(len(embeddings[:,0]))}
  with open('embedding_model.pickle', 'wb') as file:
